...
def parse_args(readed):
    # [\'][a-zA-ZРђ-РЇР°-СЏ\d\s[\]{}()\\\.\":;,-]*[\']|\b[a-zA-Z\d]+
    # [\"\'][a-zA-ZРђ-РЇР°-СЏРЃС‘\d\s[\]{}()@\\\.:;,-]*[\"\']|[a-zA-ZA-ZРђ-РЇР°-СЏРЃС‘\d\.[\]{}()@\\\.:;,-]+
    # [\"][a-zA-ZРђ-РЇР°-СЏРЃС‘\d\s[\]{}()@\\\.:;,\'-]*[\"]|[a-zA-ZA-ZРђ-РЇР°-СЏРЃС‘\d\.[\]{}()@\\\.:;,\'-]+
    # [\"][a-zA-ZРђ-РЇР°-СЏРЃС‘\d\s[\]{}()@\\\.:;,\'-/]*[\"]|[a-zA-ZA-ZРђ-РЇР°-СЏРЃС‘\d\.[\]{}()@\\\.:;,\'-/]+
    # [\"][a-zA-ZРђ-РЇР°-СЏРЃС‘\d\s[\]{}()@#_=%?\*\\\.:;,\'-/]*[\"]|[a-zA-ZA-ZРђ-РЇР°-СЏРЃС‘\d\.[\]{}()@\\\.:;,\'-/]+
    # [\"][a-zA-ZA-ZРђ-РЇР°-СЏРЃС‘\d.[\]{}()@\\:;,\'\-\/!?#$%^&*_+в„–\d]*[\"]|[a-zA-ZA-ZРђ-РЇР°-СЏРЃС‘\d.[\]{}()@\\:;,\'\-\/!?#$%^&*_+в„–]+
    # [\"][a-zA-ZA-ZРђ-РЇР°-СЏРЃС‘\d.[\]{}()<>@\\:;,\'\-\/!?#$%^&*_+в„–\d]*[\"]|[a-zA-ZA-ZРђ-РЇР°-СЏРЃС‘\d.[\]{}()@\\:;,\'\-\/!?#$%^&*_+в„–<>]+ (NOW)
    ...
    """
    res = re.findall(
        r"[\"][a-zA-ZA-ZРђ-РЇР°-СЏРЃС‘\d.[\]{}()<>@\\:;,\'\-\/!?#$%^&*_+в„–\d]*[\"]|[a-zA-ZA-ZРђ-РЇР°-СЏРЃС‘\d.[\]{}()@\\:;,\'\-\/!?#$%^&*_+в„–<>]+",
        readed,
        re.MULTILINE,
    )
    res2 = []
