                    ...
                    if console.registeredFunctions["checkConnection"](console):
                        if console.paramCount == 1:
                            ...
                            if tableData == []:
                                ...
                                rowsCount = 6
                                headers = ['Unical id','Field name','Type','NotNull','DefaultValue','pk']
                                
                                console.logger.tip(len(tableData[0]))
                                maxLengths = console.registeredFunctions['getMaxSizeRecord'](console, tableData, rowsCount, headers)
                                
                                data = headers
                                for line in tableData:
                                    for el in line:
                                        data.append(el) 
                                console.registeredFunctions['createTable'](console, rowsCount, maxLengths, data)
                ...
                def run(console):
                    if console.registeredFunctions["checkConnection"](console):
                        try:
                            ...
                            lineLengths = console.registeredFunctions["getMaxSizeRecord"](console, tableData, rowsCount, headerStrings)
